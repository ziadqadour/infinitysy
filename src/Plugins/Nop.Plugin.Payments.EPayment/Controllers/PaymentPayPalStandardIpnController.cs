...
{
    public class EPaymentIpnController : Controller
    {
        #region Fields
        ...
        public EPaymentIpnController(ILogger logger,
        ...
        public async Task<IActionResult> IPNHandler()
        {
            ...
            var newPaymentStatus = EPaymentHelper.GetPaymentStatus(paymentStatus, pendingReason);
