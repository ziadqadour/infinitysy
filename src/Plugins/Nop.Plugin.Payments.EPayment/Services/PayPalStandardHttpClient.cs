...
namespace Nop.Plugin.Payments.EPayment.Services
{
    /// <summary>
    /// Represents the HTTP client to request PayPal services
    /// </summary>
    public class EPaymentHttpClient
    {
        #region Fields

        private readonly HttpClient _httpClient;
        private readonly EPaymentSettings _payPalStandardPaymentSettings;

        #endregion

        #region Ctor

        public EPaymentHttpClient(HttpClient client,
            EPaymentSettings payPalStandardPaymentSettings)
        {
            //configure client
